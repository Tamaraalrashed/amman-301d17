...
// Joe the variable of the new Student constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
//It's for the global window object.
// 3. Explain why "this" is different when an arrow function is used.
//The value of this is the same as the this of the enclosing scope (non-arrow function). If not s, the this context will be, in the browser, the global window object.
